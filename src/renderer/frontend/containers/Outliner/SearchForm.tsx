...
import {
  ...
  initStringCriteria, initIDsCriteria, initNumberCriteria, initDateCriteria,
...
const SearchForm = observer(() => {
  ...
  const removeSearchQuery = useCallback((index: number) => uiStore.removeSearchQueryByIndex(index), []);
