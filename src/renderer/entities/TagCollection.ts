...
// const ROOT_TAG_COLLECTION_ID = 'hierarchy';

// /* A Tag Collection as it is represented in the Database */
// interface ITagCollection extends IResource {
//   id: ID;
//   name: string;
//   description: string;
//   dateAdded: Date;
...
//  * @deprecated Tags themselves will now contain sub-tags instead
//  */
// class ClientTagCollection implements ISerializable<ITagCollection> {
